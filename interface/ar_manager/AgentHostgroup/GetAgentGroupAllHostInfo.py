...
def GetAgentGroupAllHostInfo_get(info):
    """
        接口描述：获取Agent主机组的主机信息
        接口请求url：url = "/manager/agents/hostgroup/get/host?groupId=${GroupID}$&start=0&limit=-1&reverse=1"
        接口请求方法：get
    """
    # 接口前置判断
    ...
    if info['flag']:
        ...
        info = isRep(path,info,'GetAgentGroupAllHostInfo')
