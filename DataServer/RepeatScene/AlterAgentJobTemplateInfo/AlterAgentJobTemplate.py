...
class OperaAlterAgentJobTemplate(object):
    ...
    def OperaDbName(self):
        ...
        # 根据字段参数来查询数据库数据
        sql_select = "select id,name from AgentJobTemplate where id != '{JobTemplateID}' limit 1;".format(
            JobTemplateID=self.info['parameterize']['JobTemplateID'])
