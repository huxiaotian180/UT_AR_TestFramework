...
from interface.ar_manager.AgentJob.GetAgentJobTemplateAll import GetAgentJobTemplateAll_get
...
class Test_AgentJob(object):
    ...
    def test_GetAgentJobTemplateAll_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentJobTemplateAll_get, log)
