...
from interface.ar_manager.AgentJob.DeleteAgentJobTemplate import DeleteAgentJobTemplate_delete
...
class Test_AgentJob(object):
    ...
    def test_DeleteAgentJobTemplate_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteAgentJobTemplate_delete, log)
