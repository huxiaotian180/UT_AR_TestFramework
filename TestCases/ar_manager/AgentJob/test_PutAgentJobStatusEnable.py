...
from interface.ar_manager.AgentJob.PutAgentJobStatusEnable import PutAgentJobStatusEnable_put
...
class Test_AgentJob(object):
    ...
    def test_PutAgentJobStatusEnable_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, PutAgentJobStatusEnable_put, log)
