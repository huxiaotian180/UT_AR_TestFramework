...
from interface.ar_manager.AgentJob.DeleteAgentJob import DeleteAgentJob_delete
...
class Test_AgentJob(object):
    ...
    def test_DeleteAgentJob_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteAgentJob_delete, log)
