...
from interface.ar_manager.AgentJob.GetAgentJobTemplateInfo import GetAgentJobTemplateInfo_get
...
class Test_AgentJob(object):
    ...
    def test_GetAgentJobTemplateInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentJobTemplateInfo_get, log)
