...
from interface.ar_manager.AgentJob.PutAgentJobStatusDisable import PutAgentJobStatusDisable_put
...
class Test_AgentJob(object):
    ...
    def test_PutAgentJobStatusDisable_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, PutAgentJobStatusDisable_put, log)
