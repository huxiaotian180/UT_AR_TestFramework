...
from interface.ar_manager.AgentJob.AlterAgentJobTemplateInfo import AlterAgentJobTemplateInfo_put
...
class Test_AgentJob(object):
    ...
    def test_AlterAgentJobTemplateInfo_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterAgentJobTemplateInfo_put, log)
