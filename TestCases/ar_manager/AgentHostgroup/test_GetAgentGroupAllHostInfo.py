...
from interface.ar_manager.AgentHostgroup.GetAgentGroupAllHostInfo import GetAgentGroupAllHostInfo_get
...
class Test_AgentHostgroup(object):
    ...
    def test_GetAgentGroupAllHostInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentGroupAllHostInfo_get, log)
