...
from interface.ar_manager.AgentHostgroup.AlterAgentGroup import AlterAgentGroup_put
...
class Test_AgentHostgroup(object):
    ...
    def test_AlterAgentGroup_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterAgentGroup_put, log)
