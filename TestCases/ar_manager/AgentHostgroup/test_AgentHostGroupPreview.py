...
from interface.ar_manager.AgentHostgroup.AgentHostGroupPreview import AgentHostGroupPreview_post
...
class Test_AgentHostgroup(object):
    ...
    def test_AgentHostGroupPreview_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AgentHostGroupPreview_post, log)
