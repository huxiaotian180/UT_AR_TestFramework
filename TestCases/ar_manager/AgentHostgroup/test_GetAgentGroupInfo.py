...
from interface.ar_manager.AgentHostgroup.GetAgentGroupInfo import GetAgentGroupInfo_get
...
class Test_AgentHostgroup(object):
    ...
    def test_GetAgentGroupInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentGroupInfo_get, log)
