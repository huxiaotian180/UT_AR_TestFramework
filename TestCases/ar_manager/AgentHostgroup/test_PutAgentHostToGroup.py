...
from interface.ar_manager.AgentHostgroup.PutAgentHostToGroup import PutAgentHostToGroup_put
...
class Test_AgentHostgroup(object):
    ...
    def test_PutAgentHostToGroup_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, PutAgentHostToGroup_put, log)
