...
from interface.ar_manager.AgentHostgroup.AgentHostGroupCount import AgentHostGroupCount_post
...
class Test_AgentHostgroup(object):
    ...
    def test_AgentHostGroupCount_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AgentHostGroupCount_post, log)
