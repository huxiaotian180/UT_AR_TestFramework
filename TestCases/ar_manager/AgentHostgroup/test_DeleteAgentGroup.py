...
from interface.ar_manager.AgentHostgroup.DeleteAgentGroup import DeleteAgentGroup_delete
...
class Test_AgentHostgroup(object):
    ...
    def test_DeleteAgentGroup_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteAgentGroup_delete, log)
