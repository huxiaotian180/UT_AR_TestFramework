...
from interface.ar_manager.AgentHostgroup.GetAllAgentHostGroup import GetAllAgentHostGroup_get
...
class Test_AgentHostgroup(object):
    ...
    def test_GetAllAgentHostGroup_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAllAgentHostGroup_get, log)
