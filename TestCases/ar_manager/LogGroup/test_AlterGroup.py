...
from interface.ar_manager.LogGroup.AlterGroup import AlterGroup_PUT
...
class Test_LogGroup(object):
    ...
    def test_AlterGroup_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterGroup_PUT, log)
