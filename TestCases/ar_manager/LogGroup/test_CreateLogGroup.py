...
from interface.ar_manager.LogGroup.CreateLogGroup import CreateLogGroup_POST
...
class Test_LogGroup(object):
    ...
    def test_CreateLogGroup_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateLogGroup_POST, log)
