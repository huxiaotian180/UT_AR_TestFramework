...
from interface.ar_manager.LogGroup.DeleteLogGroup import DeleteLogGroup_DELETE
...
class Test_LogGroup(object):
    ...
    def test_DeleteLogGroup_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteLogGroup_DELETE, log)
