...
from interface.ar_manager.LogGroup.GetAllRootGroupInfo import GetAllRootGroupInfo_GET
...
class Test_LogGroup(object):
    ...
    def test_GetAllRootGroupInfo_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAllRootGroupInfo_GET, log)
