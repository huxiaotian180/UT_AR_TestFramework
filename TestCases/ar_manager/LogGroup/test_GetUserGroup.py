...
from interface.ar_manager.LogGroup.GetUserGroup import GetUserGroup_GET
...
class Test_LogGroup(object):
    ...
    def test_GetUserGroup_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetUserGroup_GET, log)
