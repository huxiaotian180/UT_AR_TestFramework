...
from interface.ar_manager.LogGroup.GetGroupMark import GetGroupMark_GET
...
class Test_LogGroup(object):
    ...
    def test_GetGroupMark_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetGroupMark_GET, log)
