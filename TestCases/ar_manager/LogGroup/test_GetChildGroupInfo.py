...
from interface.ar_manager.LogGroup.GetChildGroupInfo import GetChildGroupInfo_GET
...
class Test_LogGroup(object):
    ...
    def test_GetChildGroupInfo_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetChildGroupInfo_GET, log)
