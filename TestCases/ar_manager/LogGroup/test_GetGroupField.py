...
from interface.ar_manager.LogGroup.GetGroupField import GetGroupField_GET
...
class Test_LogGroup(object):
    ...
    def test_GetGroupField_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetGroupField_GET, log)
