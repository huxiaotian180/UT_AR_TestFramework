...
from interface.ar_manager.LogGroup.GetGroupInfo import GetGroupInfo_GET
...
class Test_LogGroup(object):
    ...
    def test_GetGroupInfo_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetGroupInfo_GET, log)
