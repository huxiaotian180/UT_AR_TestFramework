...
from interface.ar_manager.LogGroup.GetPathInfo import GetPathInfo_GET
...
class Test_LogGroup(object):
    ...
    def test_GetPathInfo_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetPathInfo_GET, log)
