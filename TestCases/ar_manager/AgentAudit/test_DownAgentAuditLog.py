...
from interface.ar_manager.AgentAudit.DownAgentAuditLog import DownAgentAuditLog_post
...
class Test_AgentAudit(object):
    ...
    def test_DownAgentAuditLog_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DownAgentAuditLog_post, log)
