...
from interface.ar_manager.AgentAudit.DeleteAgentAuditInfo import DeleteAgentAuditInfo1_delete
...
class Test_AgentAudit(object):
    ...
    def test_DeleteAgentAuditInfo1_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteAgentAuditInfo1_delete, log)
