...
from interface.ar_manager.AgentAudit.GetAgentAuditType import GetAgentAuditType1_get
...
class Test_AgentAudit(object):
    ...
    def test_GetAgentAuditType1_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentAuditType1_get, log)
