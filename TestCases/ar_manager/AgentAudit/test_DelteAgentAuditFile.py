...
from interface.ar_manager.AgentAudit.DelteAgentAuditFile import DelteAgentAuditFile_delete
...
class Test_AgentAudit(object):
    ...
    def test_DelteAgentAuditFile_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DelteAgentAuditFile_delete, log)
