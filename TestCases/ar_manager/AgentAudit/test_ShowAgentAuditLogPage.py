...
from interface.ar_manager.AgentAudit.ShowAgentAuditLogPage import ShowAgentAuditLogPage_post
...
class Test_AgentAudit(object):
    ...
    def test_ShowAgentAuditLogPage_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, ShowAgentAuditLogPage_post, log)
