...
from interface.ar_manager.AgentAudit.DelteAgentAuditOne import DelteAgentAuditOne_delete
...
class Test_AgentAudit(object):
    ...
    def test_DelteAgentAuditOne_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DelteAgentAuditOne_delete, log)
