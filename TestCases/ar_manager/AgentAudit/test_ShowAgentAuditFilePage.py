...
from interface.ar_manager.AgentAudit.ShowAgentAuditFilePage import ShowAgentAuditFilePage_post
...
class Test_AgentAudit(object):
    ...
    def test_ShowAgentAuditFilePage_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, ShowAgentAuditFilePage_post, log)
