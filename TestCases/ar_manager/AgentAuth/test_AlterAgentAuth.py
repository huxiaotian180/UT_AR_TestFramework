...
from interface.ar_manager.AgentAuth.AlterAgentAuth import AlterAgentAuth_put
...
class Test_AgentAuth(object):
    ...
    def test_AlterAgentAuth_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterAgentAuth_put, log)
