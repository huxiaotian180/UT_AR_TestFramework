...
from interface.ar_manager.AgentAuth.GetAgentAuthCount import GetAgentAuthCount_get
...
class Test_AgentAuth(object):
    ...
    def test_GetAgentAuthCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentAuthCount_get, log)
