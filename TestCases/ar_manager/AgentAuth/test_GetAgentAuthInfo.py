...
from interface.ar_manager.AgentAuth.GetAgentAuthInfo import GetAgentAuthInfo_get
...
class Test_AgentAuth(object):
    ...
    def test_GetAgentAuthInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentAuthInfo_get, log)
