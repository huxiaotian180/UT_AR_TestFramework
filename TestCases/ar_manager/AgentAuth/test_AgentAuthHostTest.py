...
from interface.ar_manager.AgentAuth.AgentAuthHostTest import AgentAuthHostTest_post
...
class Test_AgentAuth(object):
    ...
    def test_AgentAuthHostTest_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AgentAuthHostTest_post, log)
