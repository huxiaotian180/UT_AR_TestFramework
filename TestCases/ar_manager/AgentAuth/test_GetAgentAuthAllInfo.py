...
from interface.ar_manager.AgentAuth.GetAgentAuthAllInfo import GetAgentAuthAllInfo_get
...
class Test_AgentAuth(object):
    ...
    def test_GetAgentAuthAllInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentAuthAllInfo_get, log)
