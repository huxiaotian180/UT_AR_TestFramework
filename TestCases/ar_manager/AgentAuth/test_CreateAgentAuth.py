...
from interface.ar_manager.AgentAuth.CreateAgentAuth import CreateAgentAuth_post
...
class Test_AgentAuth(object):
    ...
    def test_CreateAgentAuth_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateAgentAuth_post, log)
