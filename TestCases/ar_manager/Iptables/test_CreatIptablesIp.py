...
from interface.ar_manager.Iptables.CreatIptablesIp import CreatIptablesIp_post
...
class Test_Iptables(object):
    ...
    def test_CreatIptablesIp_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreatIptablesIp_post, log)
