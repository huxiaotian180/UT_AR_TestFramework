...
from interface.ar_manager.Iptables.ShowIptables import ShowIptables_get
...
class Test_Iptables(object):
    ...
    def test_ShowIptables_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, ShowIptables_get, log)
