...
from interface.ar_manager.Iptables.GetIptablesCount import GetIptablesCount_post
...
class Test_Iptables(object):
    ...
    def test_GetIptablesCount_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetIptablesCount_post, log)
