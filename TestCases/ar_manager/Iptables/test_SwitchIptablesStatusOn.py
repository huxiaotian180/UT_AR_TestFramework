...
from interface.ar_manager.Iptables.SwitchIptablesStatusOn import SwitchIptablesStatusOn_post
...
class Test_Iptables(object):
    ...
    def test_SwitchIptablesStatusOn_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SwitchIptablesStatusOn_post, log)
