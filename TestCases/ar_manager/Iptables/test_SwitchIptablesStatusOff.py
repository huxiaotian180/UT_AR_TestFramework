...
from interface.ar_manager.Iptables.SwitchIptablesStatusOff import SwitchIptablesStatusOff_post
...
class Test_Iptables(object):
    ...
    def test_SwitchIptablesStatusOff_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SwitchIptablesStatusOff_post, log)
