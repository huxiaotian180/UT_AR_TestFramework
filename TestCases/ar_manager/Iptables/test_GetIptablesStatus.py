...
from interface.ar_manager.Iptables.GetIptablesStatus import GetIptablesStatus_get
...
class Test_Iptables(object):
    ...
    def test_GetIptablesStatus_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetIptablesStatus_get, log)
