...
from interface.ar_manager.Iptables.ShowContainIp import ShowContainIp_get
...
class Test_Iptables(object):
    ...
    def test_ShowContainIp_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, ShowContainIp_get, log)
