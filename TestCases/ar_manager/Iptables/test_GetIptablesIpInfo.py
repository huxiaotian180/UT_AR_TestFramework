...
from interface.ar_manager.Iptables.GetIptablesIpInfo import GetIptablesIpInfo1_get
...
class Test_Iptables(object):
    ...
    def test_GetIptablesIpInfo1_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetIptablesIpInfo1_get, log)
