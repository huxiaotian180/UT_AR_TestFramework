...
from interface.ar_manager.Iptables.UpdateIptablesStatusOn import UpdateIptablesStatusOn_post
...
class Test_Iptables(object):
    ...
    def test_UpdateIptablesStatusOn_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, UpdateIptablesStatusOn_post, log)
