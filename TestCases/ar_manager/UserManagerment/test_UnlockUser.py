...
from interface.ar_manager.UserManagerment.UnlockUser import UnlockUser_PUT
...
class Test_UserManagerment(object):
    ...
    def test_UnlockUser_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, UnlockUser_PUT, log)
