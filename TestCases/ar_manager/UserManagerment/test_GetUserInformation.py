...
from interface.ar_manager.UserManagerment.GetUserInformation import GetUserInformation_GET
...
class Test_UserManagerment(object):
    ...
    def test_GetUserInformation_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetUserInformation_GET, log)
