...
from interface.ar_manager.UserManagerment.CreateUser import CreateUser_POST
...
class Test_UserManagerment(object):
    ...
    def test_CreateUser_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateUser_POST, log)
