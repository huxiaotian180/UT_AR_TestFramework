...
from interface.ar_manager.UserManagerment.ModifyUserPassword import ModifyUserPassword_PUT
...
class Test_UserManagerment(object):
    ...
    def test_ModifyUserPassword_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, ModifyUserPassword_PUT, log)
