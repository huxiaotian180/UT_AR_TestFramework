...
from interface.ar_manager.UserManagerment.EnableUser import EnableUser_PUT
...
class Test_UserManagerment(object):
    ...
    def test_EnableUser_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, EnableUser_PUT, log)
