...
from interface.ar_manager.UserManagerment.UserLogin import UserLogin_POST
...
class Test_UserManagerment(object):
    ...
    def test_UserLogin_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, UserLogin_POST, log)
