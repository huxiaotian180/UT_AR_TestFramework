...
from interface.ar_manager.UserManagerment.DeleteUser import DeleteUser_DELETE
...
class Test_UserManagerment(object):
    ...
    def test_DeleteUser_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteUser_DELETE, log)
