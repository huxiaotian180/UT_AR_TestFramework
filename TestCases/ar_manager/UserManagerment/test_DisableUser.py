...
from interface.ar_manager.UserManagerment.DisableUser import DisableUser_PUT
...
class Test_UserManagerment(object):
    ...
    def test_DisableUser_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DisableUser_PUT, log)
