...
from interface.ar_manager.UserManagerment.GetUserCount import GetUserCount_GET
...
class Test_UserManagerment(object):
    ...
    def test_GetUserCount_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetUserCount_GET, log)
