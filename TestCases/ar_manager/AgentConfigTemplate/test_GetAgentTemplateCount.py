...
from interface.ar_manager.AgentConfigTemplate.GetAgentTemplateCount import GetAgentTemplateCount_get
...
class Test_AgentConfigTemplate(object):
    ...
    def test_GetAgentTemplateCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentTemplateCount_get, log)
