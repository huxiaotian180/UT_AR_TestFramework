...
from interface.ar_manager.AgentConfigTemplate.AlterAgentTemplate import AlterAgentTemplate_put
...
class Test_AgentConfigTemplate(object):
    ...
    def test_AlterAgentTemplate_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterAgentTemplate_put, log)
