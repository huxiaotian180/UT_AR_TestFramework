...
from interface.ar_manager.AgentConfigTemplate.GetAllAgentTemplate import GetAllAgentTemplate_get
...
class Test_AgentConfigTemplate(object):
    ...
    def test_GetAllAgentTemplate_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAllAgentTemplate_get, log)
