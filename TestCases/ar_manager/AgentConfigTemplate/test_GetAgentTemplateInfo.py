...
from interface.ar_manager.AgentConfigTemplate.GetAgentTemplateInfo import GetAgentTemplateInfo_get
...
class Test_AgentConfigTemplate(object):
    ...
    def test_GetAgentTemplateInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentTemplateInfo_get, log)
