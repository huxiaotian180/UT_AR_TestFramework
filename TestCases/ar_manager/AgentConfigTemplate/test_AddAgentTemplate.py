...
from interface.ar_manager.AgentConfigTemplate.AddAgentTemplate import AddAgentTemplate_post
...
class Test_AgentConfigTemplate(object):
    ...
    def test_AddAgentTemplate_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AddAgentTemplate_post, log)
