...
from interface.ar_manager.AgentConfigTemplate.CreateAgentJobTemplate import CreateAgentJobTemplate_post
...
class Test_AgentConfigTemplate(object):
    ...
    def test_CreateAgentJobTemplate_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateAgentJobTemplate_post, log)
