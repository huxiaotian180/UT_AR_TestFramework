...
from interface.ar_manager.AgentConfigTemplate.DeleteAgentTemplate import DeleteAgentTemplate_delete
...
class Test_AgentConfigTemplate(object):
    ...
    def test_DeleteAgentTemplate_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteAgentTemplate_delete, log)
