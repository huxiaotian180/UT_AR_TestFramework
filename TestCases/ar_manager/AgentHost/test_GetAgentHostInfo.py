...
from interface.ar_manager.AgentHost.GetAgentHostInfo import GetAgentHostInfo_get
...
class Test_AgentHost(object):
    ...
    def test_GetAgentHostInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentHostInfo_get, log)
