...
from interface.ar_manager.AgentHost.AgentHostPool import AgentHostPool_get
...
class Test_AgentHost(object):
    ...
    def test_AgentHostPool_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AgentHostPool_get, log)
