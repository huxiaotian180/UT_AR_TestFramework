...
from interface.ar_manager.AgentHost.CreateAgentHost import CreateAgentHost_post
...
class Test_AgentHost(object):
    ...
    def test_CreateAgentHost_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateAgentHost_post, log)
