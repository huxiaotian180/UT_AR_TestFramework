...
from interface.ar_manager.AgentHost.AlterAgentHost import AlterAgentHost_put
...
class Test_AgentHost(object):
    ...
    def test_AlterAgentHost_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterAgentHost_put, log)
