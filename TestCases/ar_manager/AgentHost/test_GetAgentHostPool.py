...
from interface.ar_manager.AgentHost.GetAgentHostPool import GetAgentHostPool_get
...
class Test_AgentHost(object):
    ...
    def test_GetAgentHostPool_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentHostPool_get, log)
