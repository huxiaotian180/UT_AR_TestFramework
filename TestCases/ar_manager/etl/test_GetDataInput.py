...
from interface.ar_manager.etl.GetDataInput import GetDataInput_get
...
class Test_etl(object):
    ...
    def test_GetDataInput_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetDataInput_get, log)
