...
from interface.ar_manager.etl.DeleteDataInput import DeleteDataInput_delete
...
class Test_etl(object):
    ...
    def test_DeleteDataInput_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteDataInput_delete, log)
