...
from interface.ar_manager.etl.EnableDataInput import EnableDataInput_put
...
class Test_etl(object):
    ...
    def test_EnableDataInput_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, EnableDataInput_put, log)
