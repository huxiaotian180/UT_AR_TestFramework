...
from interface.ar_manager.etl.CreateDataInput import CreateDataInput_post
...
class Test_etl(object):
    ...
    def test_CreateDataInput_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateDataInput_post, log)
