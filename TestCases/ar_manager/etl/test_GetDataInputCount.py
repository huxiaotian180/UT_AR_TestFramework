...
from interface.ar_manager.etl.GetDataInputCount import GetDataInputCount_get
...
class Test_etl(object):
    ...
    def test_GetDataInputCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetDataInputCount_get, log)
