...
from interface.ar_manager.etl.DisableDataInput import DisableDataInput_put
...
class Test_etl(object):
    ...
    def test_DisableDataInput_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DisableDataInput_put, log)
