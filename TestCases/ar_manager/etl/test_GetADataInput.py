...
from interface.ar_manager.etl.GetADataInput import GetADataInput_get
...
class Test_etl(object):
    ...
    def test_GetADataInput_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetADataInput_get, log)
