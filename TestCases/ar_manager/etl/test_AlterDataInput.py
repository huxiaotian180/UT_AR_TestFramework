...
from interface.ar_manager.etl.AlterDataInput import AlterDataInput_put
...
class Test_etl(object):
    ...
    def test_AlterDataInput_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterDataInput_put, log)
