...
from interface.ar_manager.Role.DeleteManagerRole import DeleteManagerRole_delete
...
class Test_Role(object):
    ...
    def test_DeleteManagerRole_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteManagerRole_delete, log)
