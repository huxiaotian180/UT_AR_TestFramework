...
from interface.ar_manager.Role.GetManagerRole import GetManagerRole_get
...
class Test_Role(object):
    ...
    def test_GetManagerRole_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetManagerRole_get, log)
