...
from interface.ar_manager.Role.GetManagerRoleCount import GetManagerRoleCount_get
...
class Test_Role(object):
    ...
    def test_GetManagerRoleCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetManagerRoleCount_get, log)
