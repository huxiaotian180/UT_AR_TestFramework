...
from interface.ar_manager.Role.CreateManagerRole import CreateManagerRole_post
...
class Test_Role(object):
    ...
    def test_CreateManagerRole_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateManagerRole_post, log)
