...
from interface.ar_manager.Role.UpdateManagerRole import UpdateManagerRole_put
...
class Test_Role(object):
    ...
    def test_UpdateManagerRole_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, UpdateManagerRole_put, log)
