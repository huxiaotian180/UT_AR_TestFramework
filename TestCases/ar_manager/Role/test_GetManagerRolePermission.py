...
from interface.ar_manager.Role.GetManagerRolePermission import GetManagerRolePermission_get
...
class Test_Role(object):
    ...
    def test_GetManagerRolePermission_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetManagerRolePermission_get, log)
