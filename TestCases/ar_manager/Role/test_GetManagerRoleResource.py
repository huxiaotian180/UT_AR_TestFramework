...
from interface.ar_manager.Role.GetManagerRoleResource import GetManagerRoleResource_get
...
class Test_Role(object):
    ...
    def test_GetManagerRoleResource_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetManagerRoleResource_get, log)
