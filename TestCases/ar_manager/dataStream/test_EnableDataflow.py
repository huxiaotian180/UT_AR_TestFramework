...
from interface.ar_manager.dataStream.EnableDataflow import EnableDataflow_PUT
...
class Test_dataStream(object):
    ...
    def test_EnableDataflow_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, EnableDataflow_PUT, log)
