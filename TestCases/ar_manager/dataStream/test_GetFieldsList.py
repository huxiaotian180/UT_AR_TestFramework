...
from interface.ar_manager.dataStream.GetFieldsList import GetFieldsList_GET
...
class Test_dataStream(object):
    ...
    def test_GetFieldsList_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetFieldsList_GET, log)
