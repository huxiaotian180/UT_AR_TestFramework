...
from interface.ar_manager.dataStream.CreateGeneraDataflow import CreateGeneraDataflow_POST
...
class Test_dataStream(object):
    ...
    def test_CreateGeneraDataflow_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateGeneraDataflow_POST, log)
