...
from interface.ar_manager.dataStream.DeleteGeneraDataflow import DeleteGeneraDataflow_DELETE
...
class Test_dataStream(object):
    ...
    def test_DeleteGeneraDataflow_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteGeneraDataflow_DELETE, log)
