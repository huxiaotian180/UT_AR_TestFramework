...
from interface.ar_manager.dataStream.SearchFieldValue import SearchFieldValue_POST
...
class Test_dataStream(object):
    ...
    def test_SearchFieldValue_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SearchFieldValue_POST, log)
