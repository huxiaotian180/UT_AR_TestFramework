...
from interface.ar_manager.dataStream.GetAllTypes import GetAllTypes_GET
...
class Test_dataStream(object):
    ...
    def test_GetAllTypes_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAllTypes_GET, log)
