...
from interface.ar_manager.dataStream.EditDataflow import EditDataflow_PUT
...
class Test_dataStream(object):
    ...
    def test_EditDataflow_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, EditDataflow_PUT, log)
