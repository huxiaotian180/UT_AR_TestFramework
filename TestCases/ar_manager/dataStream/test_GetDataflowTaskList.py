...
from interface.ar_manager.dataStream.GetDataflowTaskList import GetDataflowTaskList_GET
...
class Test_dataStream(object):
    ...
    def test_GetDataflowTaskList_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetDataflowTaskList_GET, log)
