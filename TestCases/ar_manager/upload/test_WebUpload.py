...
from interface.ar_manager.upload.WebUpload import WebUpload_post
...
class Test_upload(object):
    ...
    def test_WebUpload_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, WebUpload_post, log)
