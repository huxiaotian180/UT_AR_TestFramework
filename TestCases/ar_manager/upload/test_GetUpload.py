...
from interface.ar_manager.upload.GetUpload import GetUpload_get
...
class Test_upload(object):
    ...
    def test_GetUpload_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetUpload_get, log)
