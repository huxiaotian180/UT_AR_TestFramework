...
from interface.ar_manager.upload.GetUploadCount import GetUploadCount_get
...
class Test_upload(object):
    ...
    def test_GetUploadCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetUploadCount_get, log)
