...
from interface.ar_manager.upload.DeteleUpload import DeteleUpload_delete
...
class Test_upload(object):
    ...
    def test_DeteleUpload_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeteleUpload_delete, log)
