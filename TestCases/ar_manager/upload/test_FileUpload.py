...
from interface.ar_manager.upload.FileUpload import FileUpload_post
...
class Test_upload(object):
    ...
    def test_FileUpload_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, FileUpload_post, log)
