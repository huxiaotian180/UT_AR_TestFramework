...
from interface.ar_manager.AgentDeploy.AgentHostDeploy import AgentHostDeploy_post
...
class Test_AgentDeploy(object):
    ...
    def test_AgentHostDeploy_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AgentHostDeploy_post, log)
