...
from interface.ar_manager.AgentDeploy.GetAgentType import GetAgentType_get
...
class Test_AgentDeploy(object):
    ...
    def test_GetAgentType_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetAgentType_get, log)
