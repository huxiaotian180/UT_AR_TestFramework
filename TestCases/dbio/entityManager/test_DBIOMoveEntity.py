...
from interface.dbio.entityManager.DBIOMoveEntity import DBIOMoveEntity_put
...
class Test_entityManager(object):
    ...
    def test_DBIOMoveEntity_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOMoveEntity_put, log)
