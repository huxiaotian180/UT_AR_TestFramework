...
from interface.dbio.entityManager.DBIOGetEntity import DBIOGetEntity_get
...
class Test_entityManager(object):
    ...
    def test_DBIOGetEntity_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOGetEntity_get, log)
