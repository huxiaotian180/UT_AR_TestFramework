...
from interface.dbio.entityManager.DBIOUpdateEntity import DBIOUpdateEntity_put
...
class Test_entityManager(object):
    ...
    def test_DBIOUpdateEntity_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOUpdateEntity_put, log)
