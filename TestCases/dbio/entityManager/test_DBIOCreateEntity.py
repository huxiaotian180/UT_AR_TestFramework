...
from interface.dbio.entityManager.DBIOCreateEntity import DBIOCreateEntity_post
...
class Test_entityManager(object):
    ...
    def test_DBIOCreateEntity_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOCreateEntity_post, log)
