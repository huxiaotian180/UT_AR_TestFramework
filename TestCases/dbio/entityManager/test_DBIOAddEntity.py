...
from interface.dbio.entityManager.DBIOAddEntity import DBIOAddEntity_post
...
class Test_entityManager(object):
    ...
    def test_DBIOAddEntity_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOAddEntity_post, log)
