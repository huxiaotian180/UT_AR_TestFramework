...
from interface.dbio.serviceManager.DBIOAddService import DBIOAddService_post
...
class Test_serviceManager(object):
    ...
    def test_DBIOAddService_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DBIOAddService_post, log)
