...
from interface.dataManager.logWareHouse.AlterLogLibrary import AlterLogLibrary_PUT
...
class Test_logWareHouse(object):
    ...
    def test_AlterLogLibrary_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterLogLibrary_PUT, log)
