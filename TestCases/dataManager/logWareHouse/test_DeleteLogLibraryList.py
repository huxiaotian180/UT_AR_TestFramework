...
from interface.dataManager.logWareHouse.DeleteLogLibraryList import DeleteLogLibraryList_DELETE
...
class Test_logWareHouse(object):
    ...
    def test_DeleteLogLibraryList_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteLogLibraryList_DELETE, log)
