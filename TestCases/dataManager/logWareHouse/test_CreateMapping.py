...
from interface.dataManager.logWareHouse.CreateMapping import CreateMapping_POST
...
class Test_logWareHouse(object):
    ...
    def test_CreateMapping_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateMapping_POST, log)
