...
from interface.dataManager.logWareHouse.CreateLogLibrary import CreateLogLibrary_POST
...
class Test_logWareHouse(object):
    ...
    def test_CreateLogLibrary_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateLogLibrary_POST, log)
