...
from interface.dataManager.logWareHouse.UpdateLogLibraryMetadata import UpdateLogLibraryMetadata_PUT
...
class Test_logWareHouse(object):
    ...
    def test_UpdateLogLibraryMetadata_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, UpdateLogLibraryMetadata_PUT, log)
