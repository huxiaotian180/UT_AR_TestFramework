...
from interface.dataManager.logWareHouse.GetLogLibraryList import GetLogLibraryList_GET
...
class Test_logWareHouse(object):
    ...
    def test_GetLogLibraryList_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetLogLibraryList_GET, log)
