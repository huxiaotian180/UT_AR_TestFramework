...
from interface.dataManager.logWareHouse.GetLogLibraryOne import GetLogLibraryOne_GET
...
class Test_logWareHouse(object):
    ...
    def test_GetLogLibraryOne_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetLogLibraryOne_GET, log)
