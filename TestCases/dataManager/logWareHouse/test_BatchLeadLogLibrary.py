...
from interface.dataManager.logWareHouse.BatchLeadLogLibrary import BatchLeadLogLibrary_POST
...
class Test_logWareHouse(object):
    ...
    def test_BatchLeadLogLibrary_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, BatchLeadLogLibrary_POST, log)
