...
from interface.dataManager.logWareHouse.DeleteLogLibraryOne import DeleteLogLibraryOne_DELETE
...
class Test_logWareHouse(object):
    ...
    def test_DeleteLogLibraryOne_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteLogLibraryOne_DELETE, log)
