...
from interface.dataManager.logWareHouse.DeleteMapping import DeleteMapping_DELETE
...
class Test_logWareHouse(object):
    ...
    def test_DeleteMapping_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteMapping_DELETE, log)
