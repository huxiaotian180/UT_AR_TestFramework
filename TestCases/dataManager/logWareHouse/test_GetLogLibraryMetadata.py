...
from interface.dataManager.logWareHouse.GetLogLibraryMetadata import GetLogLibraryMetadata_GET
...
class Test_logWareHouse(object):
    ...
    def test_GetLogLibraryMetadata_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetLogLibraryMetadata_GET, log)
