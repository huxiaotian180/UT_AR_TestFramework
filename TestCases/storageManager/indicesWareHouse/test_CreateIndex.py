...
from interface.storageManager.indicesWareHouse.CreateIndex import CreateIndex_POST
...
class Test_indicesWareHouse(object):
    ...
    def test_CreateIndex_POST(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, CreateIndex_POST, log)
