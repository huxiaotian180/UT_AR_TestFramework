...
from interface.storageManager.indicesWareHouse.SearchIndexByID import SearchIndexByID_GET
...
class Test_indicesWareHouse(object):
    ...
    def test_SearchIndexByID_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SearchIndexByID_GET, log)
