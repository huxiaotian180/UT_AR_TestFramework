...
from interface.storageManager.indicesWareHouse.AlterIndexState import AlterIndexState_PUT
...
class Test_indicesWareHouse(object):
    ...
    def test_AlterIndexState_PUT(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, AlterIndexState_PUT, log)
