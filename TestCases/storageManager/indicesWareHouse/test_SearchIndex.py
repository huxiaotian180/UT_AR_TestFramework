...
from interface.storageManager.indicesWareHouse.SearchIndex import SearchIndex_GET
...
class Test_indicesWareHouse(object):
    ...
    def test_SearchIndex_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SearchIndex_GET, log)
