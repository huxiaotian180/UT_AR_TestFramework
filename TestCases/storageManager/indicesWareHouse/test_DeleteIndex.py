...
from interface.storageManager.indicesWareHouse.DeleteIndex import DeleteIndex_DELETE
...
class Test_indicesWareHouse(object):
    ...
    def test_DeleteIndex_DELETE(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, DeleteIndex_DELETE, log)
