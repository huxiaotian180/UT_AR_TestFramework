...
from interface.storageManager.indicesWareHouse.GetIndexList import GetIndexList_GET
...
class Test_indicesWareHouse(object):
    ...
    def test_GetIndexList_GET(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, GetIndexList_GET, log)
