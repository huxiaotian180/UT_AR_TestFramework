...
from interface.SMTP.smtp.SMTPTestInfo import SMTPTestInfo_post
...
class Test_smtp(object):
    ...
    def test_SMTPTestInfo_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SMTPTestInfo_post, log)
