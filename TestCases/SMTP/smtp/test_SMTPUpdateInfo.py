...
from interface.SMTP.smtp.SMTPUpdateInfo import SMTPUpdateInfo_put
...
class Test_smtp(object):
    ...
    def test_SMTPUpdateInfo_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SMTPUpdateInfo_put, log)
