...
from interface.SMTP.smtp.SMTPGetInfo import SMTPGetInfo_get
...
class Test_smtp(object):
    ...
    def test_SMTPGetInfo_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SMTPGetInfo_get, log)
