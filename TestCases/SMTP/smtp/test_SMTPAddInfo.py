...
from interface.SMTP.smtp.SMTPAddInfo import SMTPAddInfo_post
...
class Test_smtp(object):
    ...
    def test_SMTPAddInfo_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SMTPAddInfo_post, log)
