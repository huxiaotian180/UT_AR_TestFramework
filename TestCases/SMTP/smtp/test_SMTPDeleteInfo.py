...
from interface.SMTP.smtp.SMTPDeleteInfo import SMTPDeleteInfo_delete
...
class Test_smtp(object):
    ...
    def test_SMTPDeleteInfo_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, SMTPDeleteInfo_delete, log)
