...
from interface.ml.MachineLearning.MachineLearningCompileTask import MachineLearningCompileTask_put
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningCompileTask_put(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningCompileTask_put, log)
