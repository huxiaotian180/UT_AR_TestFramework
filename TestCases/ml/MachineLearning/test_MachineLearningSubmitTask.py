...
from interface.ml.MachineLearning.MachineLearningSubmitTask import MachineLearningSubmitTask_post
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningSubmitTask_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningSubmitTask_post, log)
