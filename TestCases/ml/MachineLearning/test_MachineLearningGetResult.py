...
from interface.ml.MachineLearning.MachineLearningGetResult import MachineLearningGetResult_get
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningGetResult_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningGetResult_get, log)
