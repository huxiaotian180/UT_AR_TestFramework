...
from interface.ml.MachineLearning.MachineLearningBatchGetTask import MachineLearningBatchGetTask1_get
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningBatchGetTask1_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningBatchGetTask1_get, log)
