...
from interface.ml.MachineLearning.MachineLearningAddTask import MachineLearningAddTask_post
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningAddTask_post(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningAddTask_post, log)
