...
from interface.ml.MachineLearning.MachineLearningDeleteTask import MachineLearningDeleteTask_delete
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningDeleteTask_delete(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningDeleteTask_delete, log)
