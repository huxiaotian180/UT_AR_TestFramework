...
from interface.ml.MachineLearning.MachineLearningGetTaskCount import MachineLearningGetTaskCount_get
...
class Test_MachineLearning(object):
    ...
    def test_MachineLearningGetTaskCount_get(self, key):
        parameter = case_info['date'][key]
        info = TestCaseDateManger.dataManger(case_info, parameter, MachineLearningGetTaskCount_get, log)
